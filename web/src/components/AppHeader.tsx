        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            style={{
              ...
              color: theme === 'dark' ? 'var(--app-accent-indigo)' : 'var(--app-accent-warning)',
            }}
          ...
          <div className="relative z-50" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-2.5 px-3 py-1.5 rounded-full transition-all hover-bg-tertiary"
            >
              <div
              ...
              >
                ...
                <div className="p-2" style={{ borderBottom: '1px solid var(--app-border-default)' }}>
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-left hover-bg-tertiary"
                ...
                <div className="p-2">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-left hover-bg-error"
